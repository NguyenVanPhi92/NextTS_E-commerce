...
export const RoomItem = ({
  ...
  return (
    <div
      ...
      className={`p-12 lg:p-16 flex items-center cursor-pointer rounded-[8px] select-none chat-room-item room-item-${
        data.room_id
    ...
    >
      ...
      <div className="flex-1">
        <div className="flex items-center justify-between mb-4">
          <p className="text-sm font-semibold leading-[20px] flex-1 line-clamp-1 mr-12 word-wrap-anywhere">
            {data.room_name}
          </p>
          ...
          {type === "history" ? (
            <button
              ...
              className="p-2"
            >
              <IoClose className="text-gray-color-3 hover:text-primary" />
            </button>
          ) : null}
        </div>
